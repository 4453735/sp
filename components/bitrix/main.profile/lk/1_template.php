            ...
            <form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
                ...
                <dl class="personal-info">
                    <dd class="rus <?=$arResult['arUser']['UF_RUS_LANG']?>">
                        Для получения аккредитационного бейджа при себе необходимо иметь оригинал паспорта и справку ПЦР-теста или предоставить QR-код о вакцинации от Covid-19 для сканирования.
                    </dd>
                    <dd class="eng <?=$arResult['arUser']['UF_ENG_LANG']?>">
                        To obtain your accreditation badge, you must have your passport and a PCR test certificate or provide  Covid-19 vaccination certificate.
                    </dd>
