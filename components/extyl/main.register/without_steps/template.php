...
<!--                </div>-->
                ...
                <div id="step4" class="step">
                    ...
                    <div class="form-box">
                        ...
                        <div class="row">
                            <label for="id111">Пункт приезда/отъезда</label>
                            <input type="text" name="UF_ARRIVAL_PLACE" class="text" value="<?=$arResult["VALUES"]['UF_ARRIVAL_PLACE']?>" err="Иванович" placeholder = "ул. Ленина д. 12" id="id111">
                        </div>
                        ...
                        <div class="submit-wrap row">
                            ...
                            <input id="register_submit_button" type="submit" name="register_submit_button check" class="submit halfwidth" value="Завершить" />
