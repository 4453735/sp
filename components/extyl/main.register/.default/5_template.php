		...
		<div id="step1" class="step">
			...
			<div class="form-box">
                ...
                <div class="row">
                    ...
                    <input type="text" name="" class="text" value="" err="Иванов" placeholder = "" id="surname_custom">
                </div>
                <div class="row">
                    <label for="name_custom" class="rus">Имя</label>
                    <label for="name_custom" class="eng hidden">Name</label>
                    <input type="text" name="" class="text" value="" err="Иван" placeholder = "" id="name_custom">
                </div>
                <div class="row">
