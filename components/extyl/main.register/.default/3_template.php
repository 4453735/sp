...
<!--                </div>-->
                ...
                <div class="row">
                    ...
                    <input name='UF_ADDRESS' class="text" type="text" value="<?=$arResult["VALUES"]['UF_ADDRESS']?>" placeholder="Улица, дом, квартира" />
                </div>
                <div class="row">
                    <label for="id15">Паспортные данные</label>
...
<!--                            <button id="btn-start-camera" class="btn-photo">Сделать фото с веб-камеры</button>-->
                ...
                <div class="row">
                    <label for="id19">Статус о вакцинации от Covid-19</label>
                    <select name="UF_VACCINE" class="select-large">
                        <option value="Не вакцинирован">Не вакцинирован</option>
                        <option value="Запланирована">Запланирована</option>
                        <option value="Первый этап вакцинации пройден">Первый этап вакцинации пройден</option>
                        <option value="Вакцинирован">Вакцинирован</option>
                        <option value="Справка о медицинском отводе от прививки">Справка о медицинском отводе от прививки</option>
                    </select>
                </div>
