		...
		<div id="step1" class="step">
			...
			<div class="form-box">
				...
				<div class="row">
					<label>Пол</label>
					<ul class="radio-list">
						<li><input type="radio" value="M" class="radio" name="REGISTER[PERSONAL_GENDER]" id="id7"<?if($arResult["VALUES"]['PERSONAL_GENDER'] == "M" || empty($arResult["VALUES"]['PERSONAL_GENDER']))echo " checked='checked'";?>><label for="id7">мужской</label></li>
						<li><input type="radio" value="F" class="radio" name="REGISTER[PERSONAL_GENDER]" id="id8"<?if($arResult["VALUES"]['PERSONAL_GENDER'] == "F")echo " checked='checked'";?>><label for="id8">женский</label></li>
					</ul>
				</div>
				<div class="row">
				...
				<h3 class="info-block">Место рождения</h3>
				<div class="row">
					<label>Страна</label>
				...
				<div class="row">
					<label>Субъект РФ (российское гражданство)</label>
