...
<!--                </div>-->
                <div class="row">
                    <label for="name_custom">First name (as to appear on badge)*</label>
                    <input type="text" name="" class="text" value="" err="Иван" placeholder = "Ivan" id="name_custom">
                </div>
                <div class="row">
                    <label for="surname_custom">Last name (as to appear on badge)*</label>
                    <input type="text" name="" class="text" value="" err="Иванов" placeholder = "Ivanov" id="surname_custom">
                </div>

                <div class="row">
                    <label for="middle_name_custom">Middle name</label>
...
<!--                </div>-->
				...
				<div class="row">
					<label for="id5">Date of birth</label>
					<select name="d">
						<option></option>
						<?for($i=1;$i<32;$i++):?>
                ...
                <div class="row">
                        <label id='UF_CAT1'>Category</label>
                ...
                <div class="row">
                    <label for="id14">City</label>
                    <input name='UF_CITY' class="text" type="text" value="<?=$arResult["VALUES"]['UF_CITY']?>" placeholder="Москва" />
                </div>
                <div class="row">
                    <label for="id15">Passport number</label>
                    <input name='UF_PASSPORT' class="text" type="text" value="<?=$arResult["VALUES"]['UF_PASSPORT']?>" placeholder="00 00 000000" />
                </div>
                <div class="row">
                    <label for="id5">Organization/ Company </label>
...
<!--                            <button id="btn-start-camera" class="btn-photo">Сделать фото с веб-камеры</button>-->
                ...
                <div class="row">
                    <label for="id19">Vaccine Status</label>
                    <select name="UF_VACCINE" class="select-large">
                        <option value="Not vaccinated">Not vaccinated</option>
                        <option value="Scheduled">Scheduled</option>
                        <option value="1st Dose done">1st Dose done</option>
                        <option value="Completed Both Dose">Completed Both Dose</option>
                    </select>
                </div>
                <div class="row scan" style="display: none">
                    <label>Документ о вакцинации</label>
...
<script>
    ...
    $('[name=UF_VACCINE]').change(function() {
        if($(this).find("option:selected").val() == "Completed Both Dose") {
            $(".scan").show();
