...
$MESS["MAIN_F_WORK_POSITION"] = "Должность";
$MESS["MAIN_FLT_WORK_POSITION"] = "Должность";
...
if(CheckFilter($arFilterFields))
{
	$arFilter = Array(
		...
		"WORK_POSITION" => $find_work_position
		);
	if ($bIntranetEdition)
...
$arFindFields = array(
		...
		GetMessage('MAIN_FLT_WORK_POSITION')
	);
if ($bIntranetEdition)
...
<tr>
    <td><?echo GetMessage("MAIN_F_WORK_POSITION")?></td>
    <td><input type="text" name="find_work_position" value="<?echo htmlspecialcharsbx($find_work_position)?>" size="47"><?=ShowFilterLogicHelp()?></td>
</tr>
<?
if ($bIntranetEdition)
{
